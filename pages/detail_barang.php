    ...
    <div class="row">
        ...
        <div class="col-lg-6 mb-4">
            <div class="image-card">
                <div class="image-wrapper" data-bs-toggle="modal" data-bs-target="#imageModal">
                    <img src="../assets/uploads/<?= $item['foto'] ?? 'placeholder.jpg'; ?>" 
                         class="item-image" 
                         alt="<?= $item['judul_laporan'] ?? 'Foto Barang'; ?>"
                         id="mainImage"
        ...
        <div class="col-lg-6">
            <div class="detail-card">
                <!-- Status Badge -->
                <span class="status-badge <?= ($item['status'] ?? 'lost') == 'lost' ? 'lost' : 'found'; ?>" id="statusBadge">
                    <i class="bi bi-<?= ($item['status'] ?? 'lost') == 'lost' ? 'exclamation-circle' : 'check-circle'; ?>"></i>
