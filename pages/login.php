        ...
        <div class="container">
            <div class="row login-container">
                    ...
                    <div class="illustration-content">
                        ...
                        <div class="profile-card d-flex flex-column align-items-center" style="padding: 15px;">
                            <div style="display: flex; gap: 15px; align-items: center;">
                                <div
                                    style="width: 50px; height: 50px; background: #ff9800; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                    <i class="fas fa-wallet" style="color: white; font-size: 24px;"></i>
                                </div>
                                <div
                                    style="width: 50px; height: 50px; background: #2196f3; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                    <i class="fas fa-mobile-alt" style="color: white; font-size: 24px;"></i>
                                </div>
                                <div
                                    style="width: 50px; height: 50px; background: #e91e63; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                        ...
                        <div style="position: relative; z-index: 2; margin: 30px 0;">
                            <svg class="person-illustration" viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <rect x="190" y="180" width="12" height="80" rx="6" fill="#424242"
                                    transform="rotate(45 196 220)" />
                                ...
                                <ellipse cx="130" cy="120" rx="20" ry="30" fill="white" opacity="0.4"
                                    transform="rotate(-45 130 120)" />
                ...
                <div class="col-lg-7 form-side">
                    ...
                    <?php if (isset($_GET['pesan'])): ?>
                        <div class="alert alert-danger" role="alert">
                            ...
                            <small>
                                ...
                                if ($_GET['pesan'] == "restricted")
                                    echo "Maaf, Anda harus login dahulu.";
                                if ($_GET['pesan'] == "logout")
                                    echo "Berhasil keluar sistem.";
                                ?>
                            </small>
                        </div>
                    <?php endif; ?>
                    ...
                    <!-- Login Form -->
                    <form action="../api/api.php" method="POST" id="loginForm">
